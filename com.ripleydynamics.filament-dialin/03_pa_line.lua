info = {
    ...
    params = {
        { name = "min_pa", label = "Lowest pressure advance (first line), e.g. 0.00", type = "string", default = "0.00" },
        { name = "max_pa", label = "Highest pressure advance (last line), e.g. 0.08", type = "string", default = "0.08" },
